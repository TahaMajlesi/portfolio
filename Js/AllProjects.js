  ...
  .then((data) => {
    ...
    data.forEach((element) => {
      document.getElementById("allProjects").innerHTML += `
        ...
        <div class="lg:w-4/12 lg:m-2 my-2 font-mono tracking-wide flex flex-col p-4 hover:bg-white hover:text-black rounded-3xl text-gray-300 transition-colors gap-y-3" >
